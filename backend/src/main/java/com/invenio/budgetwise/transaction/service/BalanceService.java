...
public class BalanceService {
    ...
    public BalanceResponse saldoDe(String email) {
        ...
        // Es la misma consulta del listado de la #7: ya filtra por usuario, asi
        // que el saldo nunca puede incluir movimientos de otra persona.
        return calcular(transactionRepository.findByUserIdOrderByDateDesc(user.getId()));
    }
